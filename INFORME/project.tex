...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Base Granular CBR 80\%: \textbf{PIPEEEEEEEEEEEEEEEEE REVISAR}
            \item Carpeta Granular de Rodadura CBR 60\%: =Para aplicar la capa se utilizo un \textbf{rendimiento de 224 $m^3$/día}. Luego para hacer la compactacion, se utilizo un \textbf{rendimiento de 16800 $m^2$/día}.
        \end{itemize}
    ...
    \begin{itemize}
        \item Excavación a Máquina en Puente y Estructuras: Se utiliza un \textbf{rendimiento de 105 $m^3$/día por maquina}. demas, es nesesario considerar la remocion de escombros,
