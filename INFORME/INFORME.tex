...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\raisebox{0.20cm}{\textbf{Tarea 1 - Métodos y Técnicas de Construcción}}}
...
\begin{flushright}
    { 
    \textbf{Alumnos:} \\
    Felipe Vicencio Fossa\\
    Lukas Wolff Casanova\\
    \vspace{0.5cm}
    \textbf{Profesor:}\\
    José Tramon Cardenas\\
}
\end{flushright}
\vspace{1cm}
%----------------------------------------------------------------------------------------
...
\nocite{*}  % Incluye todas las referencias del archivo .bib aunque no se citen en el texto
